      ...
      {items.length === 0 ? (
        ...
        <div className="cart-layout">
          ...
          <div className="cart-summary">
            ...
            {user && !user.isAdmin ? (
              <StripePayment amount={total} onSuccess={handlePaymentSuccess} onFailure={handlePaymentFailure} />
            ) : (
              <motion.button whileTap={{ scale: 0.98 }} className="checkout-btn" onClick={handleCheckout} disabled={loading || user?.isAdmin}>
